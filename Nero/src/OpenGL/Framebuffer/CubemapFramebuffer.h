...
namespace Nero
{
	...
	public:
		static Ref<CubemapFramebuffer> Create();
		static Ref<CubemapFramebuffer> Create(const FramebufferSpecification& specification);

		CubemapFramebuffer() = default;
		CubemapFramebuffer(const FramebufferSpecification& specification);
